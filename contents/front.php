...
<div class="dialog center" style="float: right;">
	<div class="blue box">
  	...
  	<div class="map"></div>
گروه کاربران لینوکس تهران هر دو هفته یکبار در روز چهارشنبه از ساعت <b>۱۸ الی ۲۰</b> جلسه برگزار میکند.
<b>آدرس محل برگزاری جلسات: خیابان کریم خان زند، خیابان نجات اللهی، نرسیده به چهار راه سپند، کوچه خسرو، پلاک ۳۵، سالن اجتماعات مرکز آموزش عالی انفورماتیک شرکت داده پردازی

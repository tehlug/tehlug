...
چیزی برای پنهان کردن ندارم و سایر سوءتفاهم‌های مسئله حریم شخصی.
<br />
<br />
در این کتاب دانیل سولوو ضمن توضیح پاسخ رایج "من چیزی برای مخفی کردن ندارم"
به بررسی وضعیت کلی پرایوسی پس از وقایع یازدهم سپتامبر در ایالات متحده میپردازد و سعی میکند
تعریف مشخصی از مسئله‌ی پرایوسی ارائه دهد. او اینطور نتیجه میگیرد که تمامی تلاشها برای ارائه‌ی
تعریف جامعی از پرایوسی محکوم به شکست است. پرایوسی یک مسئله نیست، بلکه از مسائل مختلفی
تشکیل شده که لزوما شبیه به هم نیستند. او همچنین سعی میکند تعریفی اجتماعی از مسئله‌ی پرایوسی ترسیم کند
و آنرا در نقطه‌ی مقابل تعاریف رایج از پرایوسی به عنوان یک مسئله‌ی شخصی قرار دهد. خواندن این مقاله به همه‌ی کسانی
که به مسئله‌ی پرایوسی و بررسی خطرات پیش روی ما در دنیای تکنولوژیک علاقه دارند توصیه میشود.
